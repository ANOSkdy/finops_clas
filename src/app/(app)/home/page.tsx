        ...
        <>
          ...
          <Card className="glass">
            ...
            <CardContent className="grid grid-cols-2 gap-3">
              <a href="/schedule" className="ring-focus tap-44 rounded-2xl border border-line bg-white/85 px-4 py-4 text-sm text-ink hover:bg-primary/10">Schedule</a>
              <a href="/upload" className="ring-focus tap-44 rounded-2xl border border-line bg-white/85 px-4 py-4 text-sm text-ink hover:bg-primary/10">Upload</a>
              <a href="/manual" className="ring-focus tap-44 rounded-2xl border border-line bg-white/85 px-4 py-4 text-sm text-ink hover:bg-primary/10">Manual</a>
              <a href="/settings" className="ring-focus tap-44 rounded-2xl border border-line bg-white/85 px-4 py-4 text-sm text-ink hover:bg-primary/10">Settings</a>
            </CardContent>
          </Card>
        </>
      )}
